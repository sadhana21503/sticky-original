...
export default function Home() {
  return (
    ...
    <Navbar/>
      ...
      <div className="bg-gradient-to-b from-white to-teal-700 h-auto w-auto">
      ...
      <div className="bg-customGreen p-10 md:p-20 shadow-lg w-full text-center mb-10">
        <div className="flex flex-col md:flex-row items-center justify-center mb-6 md:mb-10">
          ...
          <img src={logoo} alt="Logo" className="h-12 md:h-14 w-auto" style={{ maxWidth: '158px', maxHeight: '47px' }} />
        </div>
